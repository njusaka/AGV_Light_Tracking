...
void OLED_Init(void)        
{
  GPIO_InitTypeDef OLED_GPIO_InitStructure;
	RCC_APB2PeriphClockCmd(OLED_RCCEN_C, ENABLE); 
	RCC_APB2PeriphClockCmd(OLED_RCCEN_D, ENABLE); 
	
  OLED_GPIO_InitStructure.GPIO_Pin = OLED_SCL|OLED_SDA|OLED_RST;
	OLED_GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
	OLED_GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;
	GPIO_Init(OLED_GPIO_D, &OLED_GPIO_InitStructure); 
	
 OLED_GPIO_InitStructure.GPIO_Pin = OLED_DC;
	OLED_GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
	OLED_GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;
	GPIO_Init(OLED_GPIO_C, &OLED_GPIO_InitStructure); 	        
